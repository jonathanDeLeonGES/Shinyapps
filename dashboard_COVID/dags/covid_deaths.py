...
OUTPUT_TRANSFORM_FILE = '_time_series_covid19_deaths_global.csv'

dag = DAG('covid_deaths', description='Covid19',
          default_args={
...
def insert_process(**kwargs):
    ...
    with db_connection.begin() as transaction:
        ...
        transaction.execute("DELETE FROM covid.time_series_covid19_deaths_global WHERE 1=1")
        df.to_sql("time_series_covid19_deaths_global", #Nombre tabla
